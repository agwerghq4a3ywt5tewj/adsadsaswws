...
import com.example.minecraftplugin.commands.ShopCommand;
...
import com.example.minecraftplugin.enchants.EnchantmentManager;
import com.example.minecraftplugin.listeners.DragonParryListener;
...
public final class MinecraftPlugin extends JavaPlugin {
    ...
    private void initializeGodSystem() {
        ...
        this.transcendenceManager = new TranscendenceManager(this, godManager);
        ...
        // Initialize enchantment manager (for effect handling, not registration)
    ...
    private void registerListeners() {
        ...
        getServer().getPluginManager().registerEvents(new DragonParryListener(this), this);
    }
    ...
    // Getter for enchantment manager
