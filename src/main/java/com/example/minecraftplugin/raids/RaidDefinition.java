...
public class RaidDefinition {
    ...
    public String getFormattedInfo() {
        ...
        // Add special information for Enhanced Ender Dragon
        if ("enhanced_ender_dragon".equals(id)) {
            info.append("\n");
            info.append("§5§l=== SEKIRO-STYLE COMBAT FEATURES ===§r\n");
            info.append("§7• Posture System: Parry attacks to break dragon's posture\n");
            info.append("§7• Deathblow Mechanics: Right-click when posture is broken\n");
            info.append("§7• Parryable vs Perilous Attacks: Learn the patterns\n");
            info.append("§7• Phase-based Difficulty: Each phase has unique mechanics\n");
            info.append("§c§lNote: §r§cRequires precise timing and skill!\n");
        }
