...
public enum GodType {
    ...
    // TUTORIAL GOD - For tutorial purposes only
    TUTORIAL("Tutorial God", "The guiding spirit of new beginnings", 
             Arrays.asList("PLAINS"), 
             Material.STONE, GodTier.CORE);
    ...
    public boolean conflictsWith(GodType other) {
        // Tutorial god never conflicts
        if (this == TUTORIAL || other == TUTORIAL) {
            return false;
        }
    ...
    public static GodType[] getCoreGods() {
        // Exclude TUTORIAL from core gods
    ...
    public static GodType[] getExpansionGods() {
        // TUTORIAL is not part of expansion gods either
