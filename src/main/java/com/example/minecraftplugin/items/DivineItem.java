...
public abstract class DivineItem {
    ...
    public boolean isDivineItem(ItemStack item) {
        ...
        // Strip color codes for accurate comparison
        String itemDisplayName = ChatColor.stripColor(meta.getDisplayName());
        String thisDisplayName = ChatColor.stripColor(displayName);
        boolean matches = itemDisplayName.equals(thisDisplayName);
        // Note: Can't log here without plugin reference, but this comparison is critical
        return matches;
    }
